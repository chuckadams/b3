...
$b2varstoreset = ['action', 'gmpath', 'archivespath'];
...
switch ($action) {
      ...
      <ul>
        <li>importing users...
          <ul><?php
              ...
              ?></ul>
          <b>Done</b></li>
        <li>importing posts, comments, and karma...<br/>
          <ul><?php
    ...
    <ul>
      ...
      <li>parses the entries cgi files to import posts, comments, and karma on posts (although karma is not used on b2 yet)<br/>if authors are found not to be in gm-authors.cgi,
        imports them at level 0
      </li>
    </ul>
    <p>What it does not:</p>
    <ul>
      <li>parse gm-counter.cgi (what's the use of that file ?), gm-banlist.cgi, gm-cplog.cgi (you can make a CP log hack if you really feel like it, but I question the need of a CP
        log)
      </li>
    ...
    <form name="stepOne" method="get">
      ...
      <table cellpadding="0">
        ...
        <tr>
          <td colspan="2"><br/>This importer will search for files 00000001.cgi to 000-whatever.cgi,<br/>so you need to enter the number of the last GM post here.<br/>(if you don't
            know that number, just log into your FTP and look it out<br/>in the entries' folder)
          </td>
        </tr>
        <tr>
