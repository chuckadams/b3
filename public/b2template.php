...
$b2varstoreset = ['action', 'standalone', 'redirect', 'profile', 'error', 'warning', 'a', 'file'];
...
//		$content = str_replace("</textarea","&lt;/textarea",$content);
      ...
      <br/>
        <?php echo $tabletop; ?>
      You can also edit the <a href="b2template.php?file=b2comments.php">comments' template</a> or the <a href="b2template.php?file=b2commentspopup.php">popup comments'
      template</a>, or edit any other file (provided it's writable by the server, e.g. CHMOD 766).<br/>
      <br/>
