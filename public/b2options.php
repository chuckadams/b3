...
case "update":
	...
	if ($result==false) {
		$oops = "<b>ERROR</b>: couldn't update the options... please contact the <a href=\"mailto:$admin_email\">webmaster</a> !<br /><br />".mysqli_errno($connexion).": ".mysqli_error($connexion);
		die ($oops);
	}
