...
if ($action === "update") {
    ...
    $newautobr = addslashes($_POST["newautobr"]);
    ...
    if (!$result) {
        $oops = "<b>ERROR</b>: couldn't update the options... please contact the <a href=\"mailto:$admin_email\">webmaster</a> !<br /><br />"
  ...
  <form name="form" action="b2options.php" method="post">
    ...
    <table width="550" cellpadding="5" cellspacing="0">
      <tr>
        ...
        <td width="350"><input type="text" name="newposts_per_page" value="<?= get_settings("posts_per_page") ?>" size="3">
      ...
      <tr>
        ...
        <td><input type="text" name="newtime_difference" value="<?= $time_difference ?>" size="2">
      ...
      <tr>
        ...
        <td><select name="newautobr">
          ...
          <i>converts line-breaks into &lt;br /> tags. (
            <!--suppress HtmlUnknownAnchorTarget -->
            <a href="#autobr">note</a>
            )</i>
        </td>
      </tr>
      <tr>
        <td height="40">Date format:</td>
        <td><input type="text" name="newdate_format" value="<?= $date_format ?>" size="10">
          <i> (<a href="#dateformat">note</a>)</i>
        </td>
      </tr>
      <tr>
        <td height="40">Time format:</td>
        <td><input type="text" name="newtime_format" value="<?= $time_format ?>" size="10">
          <i> (<a href="#dateformat">note</a>)</i>
        </td>
      </tr>
      <tr>
